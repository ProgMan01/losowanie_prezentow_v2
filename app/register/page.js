...
// Strona rejestracji jako komponent asynchroniczny
export default async function RegisterPage() {
    // Pobieramy początkowy stan uczestników PRZED renderowaniem
    const participants = await getAllParticipants();
    const initialCount = participants.length;

    return (
        // Zmiana: Używamy gradientu jako bazowego tła dla przyjemniejszego efektu
        <main className="relative min-h-screen flex flex-col items-center justify-center p-3 overflow-hidden
            ...
            <div
                // Zmiana: Zmniejszono opacity do 60% i dodano delikatny blur
            ...
            {/* Karta Główna - Blask karty jest wyraźniejszy */}
            <div className="relative z-10 text-center max-w-lg w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm rounded-[30px] shadow-2xl px-6 py-4 border-4 border-double border-red-400 dark:border-red-600 christmas-card-glow max-h-[95vh] overflow-y-auto">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
                    Zarejestruj się, aby trafić do puli losowania i poznać, komu zrobisz prezent!
                </p>

                {/* Komponent zliczający i rejestrujący */}
                <ParticipantsCounter initialCount={initialCount} />
                ...
                <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
                    ...
                    >
                        Przejdź do Losowania (Krok 2) &rarr;
                    </Link>
                </div>
            </div>
